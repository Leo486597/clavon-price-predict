...
<div class="wrap hero">
  <div class="hero-card">
    ...
    <div style="text-align:center;margin-top:14px">
      <a href="methodology.html" style="font-size:13px;font-weight:600;color:var(--teal);text-decoration:none">
        How this prediction was made — method, pros &amp; cons, and how confident I am &rarr;</a>
    </div>
  </div>
</div>
...
<div class="foot">
  ...
  This is a decision-support tool, not formal financial or valuation advice. Verify against the latest URA caveats before listing.<br>
  <a href="methodology.html" style="color:var(--teal)">Read the full methodology &amp; confidence breakdown &rarr;</a>
</div>
